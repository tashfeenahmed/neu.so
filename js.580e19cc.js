...
exports.wrapLines = exports.preloadImages = void 0;
...
},{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"WQW1":[function(require,module,exports) {
"use strict";
...
},{"gsap":"TpQl"}],"j4LG":[function(require,module,exports) {
"use strict";
...
},{"split-type":"j4LG","./utils":"MgTz","gsap":"TpQl"}],"C5An":[function(require,module,exports) {
"use strict";
...
var Details = /*#__PURE__*/function () {
  function Details(el, closeDetailsCtrl) {
    ...
    this.textLinesReveal = new _textLinesReveal.TextLinesReveal(this.DOM.text); // TextReveal obj (this.DOM.title and this.DOM.link animation)
  ...
  _createClass(Details, [{
    ...
    value: function open() {
      ...
      _gsap.default.killTweensOf(this.DOM.images);
    ...
    value: function close() {
      ...
      _gsap.default.timeline({
        ...
        onComplete: function onComplete() {
          _this.DOM.el.classList.remove('details--open');
...
},{"./textReveal":"WQW1","./textLinesReveal":"GCGZ","gsap":"TpQl"}],"i0CD":[function(require,module,exports) {
"use strict";
...
var Menu = /*#__PURE__*/function () {
  function Menu(el) {
    ...
    this.DOM = {
      el: el,
      items: _toConsumableArray(el.querySelectorAll('.menu__item')),
      links: _toConsumableArray(el.querySelectorAll('.menu__item-link')),
      closeCtrl: el.querySelector('.close--menu'),
      // .details HTML elements (one per menu item)
      detailsEl: _toConsumableArray(el.querySelectorAll('.menu__item-link')).map(function (item) {
        return document.querySelector(item.href.substring(item.href.indexOf('#')));
      }),
    ...
    this.textReveal = new _textReveal.TextReveal([this.DOM.closeCtrl].concat(_toConsumableArray(this.DOM.items))); // Details instances

    this.detailsInstances = [];
    this.DOM.detailsEl.forEach(function (detailsEl) {
      return _this.detailsInstances.push(new _details.Details(detailsEl, _this.DOM.closeDetailsCtrl));
    });
    this.initEvents();
  ...
  _createClass(Menu, [{
    key: "open",
    value: function open() {
      this.DOM.el.classList.add('menu--open'); // show menu items and show close ctrl
    ...
    value: function close() {
      ...
      this.textReveal.out().then(function () {
        return _this2.DOM.el.classList.remove('menu--open');
      });
    }
  }, {
    key: "initEvents",
    value: function initEvents() {
      ...
      this.DOM.links.forEach(function (link, pos) {
        link.addEventListener('click', function (ev) {
          ev.preventDefault();

          _this3.openDetails(pos);
        });
      });
      this.DOM.closeDetailsCtrl.addEventListener('click', function () {
        return _this3.closeDetails();
      });
    }
  }, {
    key: "openDetails",
    value: function openDetails(pos) {
      // save position
      this.menuItemCurrent = pos; // show the details

      this.detailsInstances[this.menuItemCurrent].open(); // close the menu (animate the menu items out)
    ...
    value: function closeDetails() {
      if (this.menuItemCurrent === -1) return; // open the menu (animate the menu items in)

      this.open();
      this.detailsInstances[this.menuItemCurrent].close(); // reset
...
exports.Menu = Menu;
},{"./textReveal":"WQW1","./details":"C5An"}],"CZXw":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ImgReveal = void 0;
...
var ImgReveal = /*#__PURE__*/function () {
  function ImgReveal(el) {
    _classCallCheck(this, ImgReveal);
  ...
  _createClass(ImgReveal, [{
    key: "in",
    value: function _in() {
      _gsap.gsap.killTweensOf([this.DOM.innerImages, this.DOM.outerImages, this.DOM.el]);
...
exports.ImgReveal = ImgReveal;
},{"split-type":"j4LG","./utils":"MgTz","gsap":"TpQl"}],"QvaY":[function(require,module,exports) {
"use strict";
...
DOM.menuCtrl = document.querySelector('.menu-link'); // menu container

DOM.menuWrap = document.querySelector('.menu'); // text content elements
...
DOM.img = document.querySelector('.deco'); // page state

var state = 0; // text lines reveal obj

var textLinesReveal = new _textLinesReveal.TextLinesReveal([DOM.textContent.primary, DOM.textContent.secondary]); // Image reveal obj

var imgReveal = new _imgReveal.ImgReveal(DOM.img); // Other text animations

var textReveal = new _textReveal.TextReveal([DOM.textContent.heading, DOM.menuCtrl]); // Menu

var menu = new _menu.Menu(DOM.menuWrap); // show the initial texts and images

var showContent = function showContent() {
  textReveal.in(); // show texts (slide in)

  textLinesReveal.in(); // show image

  imgReveal.in(); // also show frame
...
var hideContent = function hideContent() {
  // hide texts
  textReveal.out(); // hide texts (lines)

  textLinesReveal.out(); // hide image(s)

  imgReveal.out(); // also hide frame
...
DOM.menuCtrl.addEventListener('click', function () {
  if (state !== 0) return;
  state = 1;
  hideContent();
  menu.open();
...
menu.DOM.closeCtrl.addEventListener('click', function () {
  if (state !== 1) return;
  state = 0;
  showContent();
  menu.close();
...
(0, _utils.preloadImages)('.deco__img, .panel__img').then(function () {
